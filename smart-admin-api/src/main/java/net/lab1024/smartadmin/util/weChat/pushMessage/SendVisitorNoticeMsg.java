 ...
 * 发送来访通知信息
 */
public class SendVisitorNoticeMsg {
     ...
     * openId 用户标识
     */
    public static void send_template_message(String openId,String firstStr,String keyword1Str,String keyword2Str,String keyword3Str ) {

        String appId = WeChatConfig.appid;
        String appSecret = WeChatConfig.secret;
        String templateId = WeChatConfig.visitorNoticeTemplateId;
