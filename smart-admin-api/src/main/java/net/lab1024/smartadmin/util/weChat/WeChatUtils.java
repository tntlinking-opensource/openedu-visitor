...
public class WeChatUtils {
    ...
    public static JSONObject getAccessToken(String code) {
        String url = WeChatUtils.getAccessTokenUrl.replace("APPID", WeChatConfig.appid).replace("SECRET", WeChatConfig.secret)
                .replace("CODE", code);
    ...
    public static JSONObject getRefreshAccessToken(String refreshToken) {
        String url = WeChatUtils.getRefreshAccessTokenUrl.replace("APPID", WeChatConfig.appid).replace("REFRESH_TOKEN",
                refreshToken);
        JSONObject jsonObj= JSONObject.fromObject(httpRequest(url, "POST", null));
        return jsonObj;
    }
     ...
     *            微信网页授权accessToken
     */
    public static JSONObject getWXUserInfoUrl(String openId, String accessToken) {
     ...
     * @param accessToken
     */
    public JSONObject checkAccessToken(String openId, String accessToken) {
