...
public interface EmployeeDao extends BaseMapper<EmployeeEntity> {
     ...
     * @return
     */
    List<EmployeeDTO> getEmployeeByIds(@Param("ids") List<Integer> employeeIds);
     ...
     */
    //用于审核人选择
    List<EmployeeVO> getEmployeeByDeptId(@Param("departmentId") Long departmentId);
    //用于员列表
    List<EmployeeVO> getEmployeesByDeptId(@Param("departmentId") Long departmentId);
    ...
    List<EmployeeVO> getEmployeeIdByDeptId(Long departmentId);
     ...
     * 根据 部门 id 获取对应所有员工
     */
    //List<EmployeeEntity> getEmployeesByDepartmentId(Integer id);
     ...
     * @return
     */
    Integer updateOpenidById(@Param("employeeId") Long employeeId, @Param("openid") String openid);
     ...
     * @return
     */
    List<EmployeeVO> getByOpenid(@Param("openid") String openid);
}