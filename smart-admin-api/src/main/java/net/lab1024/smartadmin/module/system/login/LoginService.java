...
import net.lab1024.smartadmin.util.cas.CasUtils;
...
//        }
     ...
     * @return 登录用户基本信息
     */
    public ResponseDTO<LoginDetailVO> loginByOpenid(String openid, HttpServletRequest request) {
        EmployeeDTO employeeDTO = null;
        List<EmployeeVO> employeeVOS = employeeDao.getByOpenid(openid);
        if (employeeVOS != null && employeeVOS.size() != 0) {
            employeeDTO = employeeDao.getEmployeeById(employeeVOS.get(0).getId());
        }
