...
public class LoginController {
    ...
    @PostMapping("/session/loginByOpenid/{openid}")
    @ApiOperation(value = "登录", notes = "登录")
    @NoNeedLogin
    public ResponseDTO<LoginDetailVO> loginByOpenid(@PathVariable String openid, HttpServletRequest request) {
        return loginService.loginByOpenid(openid, request);
    }
