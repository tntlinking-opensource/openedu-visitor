    ...
    <div>
        <Card class="smart-query-card">
            ...
            <Row class="smart-query-form-row">
                <span>
                    部门 :
                    <Input placeholder="请输入部门" style="width: 180px" v-model="queryForm.departmentId" />
                </span>
                <span>
                    审核人 :
                    <Input placeholder="请输入审核人" style="width: 180px" v-model="queryForm.employeeId" />
                </span>
                <ButtonGroup>
                    <Button
                            @click="queryList"
                            icon="ios-search"
                            type="primary"
                            v-privilege="'reviewer-list-query'"
                    >查询</Button>
                    <Button
        ...
        <Card class="warp-card">
            ...
            <Row class="marginBottom10">
                ...
                <Button
                        ...
                        size="small"
                        type="error"
                        v-privilege="'reviewer-list-batch-delete'"
                >批量删除</Button>
                ...
                <!-- <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'reviewer-list-export-all'"
                >导出全部</Button>
                ...
                <Button
                        ...
                        size="small"
                        type="warning"
                        v-privilege="'reviewer-list-batch-export'"
                >批量导出</Button> -->
...
<script>
    ...
    import ReviewerListForm from './components/reviewer-list-form';
                    ...
                    columnArray: [
                        {
                            ...
                            title: 'id',
                            key: 'id',
                            //tableColumn: 'vis_department_reviewer.id',
                            sortable: 'custom'
                        },
                                                {
                            title: '部门',
        ...
        methods: {
            ...
            async queryList() {
                ...
                try {
                    ...
                    let result = await reviewerApi.queryReviewer(params);
            ...
            async batchDelete() {
                this.$Spin.show();
                await reviewerApi.batchDeleteReviewer(
            ...
            async exportAll(){
                try{
                    ...
                    let params = this.convertQueryParam();
                    await reviewerApi.exportAll(params);
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            async batchExport(){
                ...
                try{
                    ...
                    await reviewerApi.batchExport(this.mainTableSelectArray.map(e => e.id));
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            showEditReviewerForm(updateObject){
