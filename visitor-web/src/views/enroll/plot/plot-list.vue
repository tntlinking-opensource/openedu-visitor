    ...
    <div>
        <Card class="smart-query-card">
            ...
            <Row class="smart-query-form-row">
                <span>
                    所属社区&nbsp;&nbsp;
                    <Select v-model="queryForm.communityId" clearable  style="width:180px" @on-change="queryList">
                ...
                <span>
                    名称&nbsp;&nbsp;
                    <Input placeholder="请输入小区名称" style="width: 180px" v-model="queryForm.name" />
                </span>
                <ButtonGroup>
                    <Button
                            @click="queryList"
        ...
        <Card class="warp-card">
            ...
            <Row class="marginBottom10">
                <Button
                        @click="showAddPlotForm"
                        icon="md-add"
                        size="small"
                        type="primary"
                        v-privilege="'plot-list-add'"
                >新建数据</Button>
                <Button
                        ...
                        size="small"
                        type="error"
                        v-privilege="'plot-list-batch-delete'"
                >批量删除</Button>
            </Row>
            <!-------操作按钮行 end------->
...
<script>
    ...
    import PlotListForm from './components/plot-list-form';
                    ...
                    columnArray: [
                        {
                            ...
                            title: 'ID',
                            key: 'id',
                            tableColumn: 'e_plot.id',
                            width: 100,
                        },
                                                {
                            title: '所属社区',
                            key: 'communityName',
                            tableColumn: 'e_plot.community_id',
                            width: 200,
                        },
                                                {
                            title: '小区名称',
                            key: 'name',
                            tableColumn: 'e_plot.name',
                            width: 200,
                        },
                                                {
                            title: '备注',
                            key: 'remark',
                            tableColumn: 'e_plot.remark',
                        },
                                                {
                            title: '创建时间',
                            key: 'createTime',
                            tableColumn: 'e_plot.create_time',
                            width: 200,
                        },
                                                {
                            title: '操作',
                            ...
                            render: (h, params) => {
                                return h('div', [
                                    h('Button', {
                                        ...
                                        on: {
                                            click: () => {
                                                this.showEditPlotForm(params.row);
                                            }
                                        }
                                    }, '编辑')
                                ]);
        ...
        methods: {
            ...
            async queryList() {
                ...
                try {
                    ...
                    let result = await plotApi.queryPlot(params);
