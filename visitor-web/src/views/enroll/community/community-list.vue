    ...
    <div>
        <Card class="smart-query-card">
            ...
            <Row class="smart-query-form-row">
                <span>
                    小区名称&nbsp;&nbsp;
                    <Input placeholder="请输入社区区名称" style="width: 180px" v-model="queryForm.name" />
                </span>
                <ButtonGroup>
                    <Button
                            @click="queryList"
                            icon="ios-search"
                            type="primary"
                            v-privilege="'community-list-query'"
                    >查询</Button>
                    <Button
        ...
        <Card class="warp-card">
            ...
            <Row class="marginBottom10">
                <Button
                        ...
                        size="small"
                        type="primary"
                        v-privilege="'community-list-add'"
                >新建数据</Button>
                <Button
                        ...
                        size="small"
                        type="error"
                        v-privilege="'community-list-batch-delete'"
                >批量删除</Button>
            </Row>
            <!-------操作按钮行 end------->
...
<script>
    ...
    import CommunityListForm from './components/community-list-form';
                    ...
                    columnArray: [
                        {
                            ...
                            title: '备注',
                            key: 'remark',
                            tableColumn: 'e_community.remark',
                            align: 'center',
                        },
                                                {
                            title: '创建时间',
                            key: 'createTime',
                            tableColumn: 'e_community.create_time',
                            width: 200,
                            align: 'center',
                        },
                                                {
                            ...
                            render: (h, params) => {
                                return h('div', [
                                    h('Button', {
                                        ...
                                        on: {
                                            click: () => {
                                                this.showEditCommunityForm(params.row);
                                            }
                                        }
                                    }, '编辑')
                                ]);
        ...
        methods: {
            ...
            async queryList() {
                ...
                try {
                    ...
                    let result = await communityApi.queryCommunity(params);
            ...
            async batchDelete() {
                this.$Spin.show();
                await communityApi.batchDeleteCommunity(
            ...
            async exportAll(){
                try{
                    ...
                    let params = this.convertQueryParam();
                    await communityApi.exportAll(params);
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            async batchExport(){
                ...
                try{
                    ...
                    await communityApi.batchExport(this.mainTableSelectArray.map(e => e.id));
                }  catch(e){
                    console.log(e);
                }finally{
            ...
            showEditCommunityForm(updateObject){
