...
export const departmentApi = {
  ...
  getListEmployeeByDepartmentId: (id) => {
    return getAxios('/department/listEmployeeByDepartmentId/' + id);
  },
  ...
  // 显示详情
  getRealDetails: (id) => {
    return getAxios('/department/getRealDetails/' + id);
  },
  // 根据部门名称获取部门
  getDepartmentByDepartmentName: (departmentName) => {
    return getAxios('/department/getDepartmentByDepartmentName?departmentName=' + departmentName);
  },
};
