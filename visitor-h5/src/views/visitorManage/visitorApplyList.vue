  ...
  <div class="body_w">
    ...
    <van-form v-if="details.length != 0" style="width: 100%;height: 85%;overflow-y: auto;">
      ...
      >
        ...
        <template #footer>
          <van-button round  color="linear-gradient(to right, #ff6034, #ee0a24)" size="small" :to="{ name: 'visitorApplyDetail', params: { id: item.id } }" style="width:8em;">查看</van-button>
        </template>
      </van-card>
...
import Vue from 'vue';
import { Cell, CellGroup } from 'vant';import config from '@/config';
